...
const Main = ({movies, result, page, setPage, setPageLoad, search, setSearch, searchMovie, filter, setFilter}) => {
                ...
                <Container>
                    ...
                    {movies.length !== 0 ?
                        <>
                            ...
                            <PaginationItems result={result} setPageLoad={setPageLoad} page={page} setPage={setPage} setFilter={setFilter} />
                        </>
                        : <Preloader />
                    }
                </Container>
